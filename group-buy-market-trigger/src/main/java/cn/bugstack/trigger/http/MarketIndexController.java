    ...
    public Response<GoodsMarketResponseDTO> queryGroupBuyMarketConfig(@RequestBody GoodsMarketRequestDTO requestDTO) {
        try {
           ...
           //1.营销优惠试算：
            ...
            GoodsMarketResponseDTO.Goods goods = GoodsMarketResponseDTO.Goods.builder().goodsId(requestDTO.getGoodsId())
            ...
            GoodsMarketResponseDTO.TeamStatistic statistic = GoodsMarketResponseDTO.TeamStatistic.builder()
                    ...
                    .allTeamUserCount(teamStatistic.getAllTeamUserCount()).build();
            ...
            //封装数据：
            GoodsMarketResponseDTO goodsMarketResponseDTO = GoodsMarketResponseDTO.builder().goods(goods).teamList(teams).teamStatistic(statistic).build();
            return Response.<GoodsMarketResponseDTO>builder()
